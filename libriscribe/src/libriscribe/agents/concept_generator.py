...
from libriscribe.utils.voice_prefix import voice_lead
    ...
    def execute(
        ...
        try:
            ...
            if project_knowledge_base.book_length == "Short Story":
                ...
                initial_prompt = voice_lead(project_knowledge_base) + f"""Generate a book concept for a {project_knowledge_base.genre} {project_knowledge_base.category} ({project_knowledge_base.book_length}).
            The book should be written in {project_knowledge_base.language}.
            ...
            critique_prompt = voice_lead(project_knowledge_base) + f"""Critique the following book concept:
            ...
            refine_prompt = voice_lead(project_knowledge_base) + f"""Refine the book concept based on the critique.  Address the weaknesses and improve the concept.
            The book should be written in {project_knowledge_base.language}.
